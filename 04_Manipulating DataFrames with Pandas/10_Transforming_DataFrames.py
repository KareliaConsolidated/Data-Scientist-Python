...
df = pd.read_csv('../Dataset/Manipulating DataFrames with Pandas/sales.csv', index_col='month')
...
weather = pd.read_csv('../Dataset/Manipulating DataFrames with Pandas/pittsburgh2013.csv')
...
election = pd.read_csv('../Dataset/Manipulating DataFrames with Pandas/pennsylvania2012_turnout.csv')
